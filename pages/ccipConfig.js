export const CCIP_BnM_Address = "0xea1e08A176528e2d7250a6F7001F18EDF0CaeCF0";
export const CCIP_LnM_Address = "0xYourLnMTokenAddress"; // Замените на реальный адрес
...
export const routerConfig = {
    ...
    soneium: {
        chainSelector: "12505351618335765396", // Пример селектора для Polygon
        address: "0x8C8B88d827Fe14Df2bc6392947d513C86afD6977", // Адрес роутера CCIP в Polygon
        explorer: "https://soneium.blockscout.com/" // Ссылка на эксплорер
    }
};

// Пример функции для получения конфигурации по имени сети
